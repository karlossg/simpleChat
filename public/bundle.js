...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.state = { users: [], messages: [], text: '', name: '', date: '' };
    return _this;
  }
...
var MessageList = function MessageList(props) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    props.messages.map(function (message, i) {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Message, { key: i, from: message.from, text: message.text, stamp: message.date });
    })
  );
};
